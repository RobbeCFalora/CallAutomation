...
# E-maildomein van je eigen team (Stretch Innovation). Gebruikt om interne
# gesprekken (bv. Dylan met Gauthier/Stijn, geen externe klant/prospect
# aanwezig) te herkennen en NIET te analyseren - zie is_internal_meeting() in
# fathom_client.py. Optioneel te overschrijven via env var, met een default
# zodat dit niet meteen als verplichte secret moet worden toegevoegd.
FALORA_EMAIL_DOMAIN = os.environ.get("FALORA_EMAIL_DOMAIN") or "stretchinnovation.be"
